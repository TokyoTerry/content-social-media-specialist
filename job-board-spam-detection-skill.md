# Job Board Spam/Filter Detection Skill

**Purpose:** Screen remote job platforms for viability, TT eligibility, hidden paywalls, and scam/spam patterns before applying.
...
## PART 1: PLATFORM SCREENING WORKFLOW
...
- [ ] **Paywall obscured:** "$2.95 intro" without mentioning 12-month lock until secondary text (We Work Remotely pattern)
- [ ] **Defunct platform:** Last job posted 2022+; archived documentation; redirects to new platform; GitHub Jobs model
...
- [ ] **Required subscription to see job descriptions:** Full details paywalled (Remotive Accelerator model); free tier shows only 2,000 of 30,000 jobs

**CATEGORY B — SCAM/EXPLOITATION RED FLAGS (Platform Behavior):**

- [ ] **Promises unrealistic pay:** Entry-level "AI trainer" at $50/hr without vetting; too-good-to-true listings
...
- [ ] **Vague job descriptions + hyper-local posting:** "Senior Writer needed in Tunapuna, Trinidad" with foreign parent company (Odixcity model)
...
## PART 2: PLATFORM CLASSIFICATION
...
- TT fit: ✓ Worldwide
- Cost: $0 (Pro = $2.95→$14.95/mo, 12-month lock, but free tier works)
...
## PART 3: JOB LISTING RED FLAG CHECKLIST
...
## PART 5: INTEGRATION WITH JOB SEARCH TABLE
...
| **Status** | T's current action | Active Search / Monitor / Blacklisted |
...
## PART 6: WORKFLOW FOR NEW PLATFORM
...
## PART 7: RED FLAG PHRASES (Copy-Paste Detection)
...
## PART 8: TRUSTED PLATFORMS (Your Validated Tier 1 List)
...
**Scenario:** T receives recommendation to apply to "RemoteByDesign.co" for Content Writer role.
...
6. **Add to table:**
   - Platform: RemoteByDesign.co
   - Tier: Skip
   - TT Score: 8/15
   - Red Flags: 3 (no country list; payment TT-unclear; eligibility unconfirmed)
   - Cost: Free (payment method unclear)
   - Last Checked: 2026-09-06
   - Status: Blacklisted
   - Notes: "Do not pursue; payment rails TT-unclear; support unresponsive to country questions"

7. **Action:** Do NOT apply; do NOT contact platform; do NOT spend time creating profile.

---

## FINAL CHECKLIST (Before Applying to ANY Platform)
